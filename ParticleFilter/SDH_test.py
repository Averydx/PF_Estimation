...
real_beta = pd.read_csv('/Users/averydrennan/ParticleFilter/PF_Estimation/data_sets/3_day_moving_avg.csv')
...
algo = TB_SDH(integrator=solver,
                         perturb=perturb,
                         resampler=resample,
                         context=Context(population=4_497_000,state_size=4,particle_count=1000))
