...
real_beta = pd.read_csv('C:\\Users\\avery\\PF-Estimation\\PF_Estimation\\jupyter notebooks\\FLU_ADMISSIONS_DAILY.csv')
...
# euler = Euler()
solver = EulerSolver()
perturb = MultivariatePerturbations(params={"sigma1":0.2,"sigma2":0.1})
resample = NBResample()

algo = TimeDependentAlgo(integrator=solver,
                         perturb=perturb,
                         resampler=resample,
                         context=Context(population=39_000_000,state_size=4,particle_count=10000))
