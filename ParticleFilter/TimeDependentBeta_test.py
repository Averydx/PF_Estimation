...
real_beta = pd.read_csv('C:/Users/avery/PF-Estimation/PF_Estimation/data_sets/FLU_HOSPITALIZATIONS.csv')
...
algo = TimeDependentAlgo(integrator=solver,
                         perturb=perturb,
                         resampler=resample,
                         context=Context(population=7_000_000,state_size=4,particle_count=1000))
