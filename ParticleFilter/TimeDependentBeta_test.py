...
real_beta = pd.read_csv('/Users/averydrennan/ParticleFilter/PF_Estimation/data_sets/7_day_maricopa.csv')
...
algo = TimeDependentAlgo(integrator=solver,
                         perturb=perturb,
                         resampler=resample,
                         context=Context(population=4_497_000,state_size=4,particle_count=10000))
