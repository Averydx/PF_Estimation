...
if __name__ == '__main__':
    ...
    algo.initialize({"beta":np.array([-1,-1,-1,-1,-1,-1]),"gamma":np.array([0.25]),"xi":np.array([1/90]),"theta":np.array([0.1]),"move_control":np.array([0.9]),'hospitalization_rate': np.array([0.001]),
        'hospitalization_duration':np.array([5.3]),'infection_duration': np.array([4.0]),
        'immunity_duration': np.array([90.0])})
    out = algo.run()
